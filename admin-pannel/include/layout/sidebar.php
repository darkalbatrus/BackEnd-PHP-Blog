      ...
      <ul class="nav flex-column pe-3">
        <li class="nav-item">
          <a
            ...
            href="/php-course-blog-template/admin-pannel/index.php">
            <i
              class="bi bi-house-fill fs-4 "></i>
        ...
        <li class="nav-item">
          <a
            ...
            href="/php-course-blog-template/admin-pannel/pages/posts/index.php">
            <i
              class="bi bi-file-earmark-image-fill fs-4 "></i>
